...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '章鱼腿很长', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '硬件开发，一个向往草原和远方的牛马', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dl07.vip', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '章鱼腿很长, 独立博客, 硬件开发, quickmodule', // 网站关键词 英文逗号隔开
